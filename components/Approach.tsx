  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        des="Once we agree on the plan, We cue my lofi playlist and dive intocoding. From initial sketches to polished code, we keep you updated
        ...
        />}
        des="This is where the magic happens! Based on the approved design, We'll translate everything into functional code, building your product
        from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}

       ...
       absolute top-0 left-0 flex items-center justify-center">
        ...
        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                ...
                <TextGenerateEffect className="text-center text-[40px] md:text-5xl lg:text-6xl" words="Transforming Concepts into Seamless User Experiences, Matrix Nodes" />
                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                    Hi, We&apos;re an end to end Web Solutions company, based in US.
                </p>
                <a href="#about">
                    <MagicButton 
                    title={"See our work"} 

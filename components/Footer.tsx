       ...
       {/* <div className='w-full absolute left-0 -bottom-72'>
        ...
        <div className='flex flex-col items-center'>
            <h1 className='heading lg:max-w-[45vw]'>
                Ready to take <span className='text-purple'>your</span> digital prensence to the next level?
            </h1>
            ...
            <a href="inquiry@matrixnodes.com">
                <MagicButton 
        ...
        <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
            ...
            md:font-normal font-light'>Copyright © 2022 Matrix Nodes</p>
